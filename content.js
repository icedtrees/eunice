...
var chibirdImages = [
  {
    'content': [
      ...
      'stronger-life.jpg',
      `yeah, and ur life has been getting harder ever since. not only did you have to deal with your ed, u had to perform perfectly in the hsc, get into med, pass radiography, get into med again, and pass med exams - all while dealing with a ton of shit. what a life man. u never signed up for any of this. except med i guess, u signed yourself up for that. congrats again on getting into med! maybe one day u'll find something else worth fighting for.`,
      'rain-sunshine-rainbow.jpg',
      `i feel like some of the best parts of my life have been transitions from things like my junior high school to baulko. only way is up, right?`
    ]
  }
];
